...
class MyApp(QWidget) : # 정의
    ...
    def initUI(self) :
        ...
        self.strArea1 = ['종로구', '태종대', '수창동', '신흥', '서석동', '읍내동',' 울산항',' 목감동',' 중앙로', '용담동',' 서천읍',' 삼천동','용담동', '청송읍', '대산면', '이도동', '신흥동']
    ...
    def cboAreahandler(self) : # 콤보박스 항목이 변화할 때 호출
        self.leArea.setText(self.strArea1[self.cboArea.currentIndex()])
